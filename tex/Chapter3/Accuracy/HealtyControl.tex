\begin{document}
	...
	% The segmentation  and made as  a benchmark, in order to ensure that no areas was identified. However, as we will see, some false positive will raise, mainly due to movement artifacts due to respiratory cycle and heartbeat. 
