...
\begin{document}
	...
	This process allows to optimize the parameters in order to obtain the best results as possible. As reference labels I have used the ones valuated as gold standard from two experts radiologists whith more than $5$ years of experience.
